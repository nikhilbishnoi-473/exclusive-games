...
function Footer() {
    return (
        <footer className='bg-black relative  overflow-hidden' id='ofert'>
                ...
                <div className='flex flex-wrap mx-[-12px] flex-row  '>
                    ...
                    <div className='md:w-[33.33%]  lg:w-[16.66%] max-md:w-[50%] px-[12px]  max-sm:w-full max-md:pt-[30px] pt-[74px] max-md:pb-0 pb-[40px] flex lg:justify-end'>
                        <ul>
                            ...
                            <li className='font-Inter font-[500] cursor-pointer text-[16px]  text-[#CCCCCC] pt-[16px]    '>Hogar</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC]  pt-[12px]  '>Misión</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC] pt-[12px]  '>Tragamonedas</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC] pt-[12px]   '>Por qué elegirnos</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC] pt-[12px]    '>Ofertas</li>
                        </ul>
                    </div>
                    <div className='md:w-[33.33%]  lg:w-[25%] max-md:w-[50%] px-[12px] max-sm:w-full max-md:pt-[30px] pt-[74px] flex lg:justify-center'>
                        <ul className='flex flex-col'>
                            <li className='font-Inter font-[700] cursor-pointer text-[16px] leading-[25.6px] text-white    '>Atención al cliente</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC] pt-[16px]    '>¿Necesitas ayuda?</li>
                            <li className='font-Inter font-[500] cursor-pointer text-[16px] text-[#CCCCCC]  pt-[12px]     '>política de privacidad</li>
                            <li className='font-Inter text-nowrap cursor-pointer font-[500] text-[16px] text-[#CCCCCC] pt-[12px]    '>Términos de servicios</li>
                        </ul>
                    </div>
                    <div className='md:w-[33.33%]  lg:w-[25%] max-md:w-[50%] px-[12px] max-sm:w-full max-md:pt-[30px]  pt-[74px] flex lg:justify-end'>
                        <div className='  '>
                            <ul className=''>
                                <li className='font-Inter cursor-pointer font-[700] text-[16px] leading-[25.6px] text-white  '>Ponerse en contacto</li>
                                <div className='flex pt-[16px] cursor-pointer gap-[8px] items-center'>
                                    ...
                                    <li className='font-Inter cursor-pointer font-[500] text-[16px] text-[#CCCCCC]    '>juegosexclusivos@gmail.com</li>
                                    </a>
                                </div>
                                <div className='flex pt-[16px] cursor-pointer gap-[8px] items-center'>
                                   ...
                                   <li className='font-Inter font-[500] text-[16px] text-[#CCCCCC]     '>(101)342-7873</li>
                                   </a>
                                </div>
